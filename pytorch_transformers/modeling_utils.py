...
class PreTrainedModel(nn.Module):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        embeddings_matrix = kwargs.pop('embeddings_matrix', None)
        visual_config = kwargs.pop('visual_config', None)
        cache_dir = kwargs.pop('cache_dir', None)
        ...
        # Instantiate model.
        model = cls(config, embeddings_matrix, visual_config, *model_args, **model_kwargs)
