...
from .modeling_bert import (BertConfig, BertPreTrainedModel, BertModel, BertForPreTraining,
                            BertForMaskedLM, BertForNextSentencePrediction,BertForSequenceClassificationVisual,BertForSequenceClassificationVisualGlobal,
                            BertForSequenceClassification, BertForMultipleChoice,BertForSequenceClassificationVisualAtt,BertForSequenceClassificationVisualAttEval,
                            BertForTokenClassification, BertForQuestionAnswering,BertForSequenceClassificationVisualAttEvalEmb,BertForSequenceClassificationVisualAttEvalHeat,
